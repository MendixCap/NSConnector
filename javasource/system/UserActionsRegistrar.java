...
public class UserActionsRegistrar implements EventHandler
{
	...
	public void handleEvent(Event event)
	{
		if (event.getTopic().equals(com.mendix.core.event.EventConstants.ModelLoadedTopic()))        
		{
			...
			component.actionRegistry().registerUserAction(nsconnector.actions.LiveDepartures.class);
			component.actionRegistry().registerUserAction(nsconnector.actions.RetrieveStationsList.class);
			component.actionRegistry().registerUserAction(nsconnector.actions.TravelAdvice.class);
			component.actionRegistry().registerUserAction(nsconnector.actions.TravelAdviceSimple.class);
